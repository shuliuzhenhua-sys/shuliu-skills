...
import { normalizeOutputImagePath, withDetectedImageExtension } from "./output-path";
...
function printUsage(): void {
  console.log(`Usage:
  npx -y bun scripts/main.ts --prompt "A cat" --image cat.jpg
  npx -y bun scripts/main.ts --prompt "A landscape" --image landscape.jpg --ar 16:9
  npx -y bun scripts/main.ts --promptfiles system.md content.md --image out.jpg
